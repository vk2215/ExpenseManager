...
public class NotificationService {
    ...
    public void sendDailyIncomeExpenseReminder(){
        ...
        for(ProfileEntity profile : profiles){
            String body = "Hi" + profile.getFullName() + ",<br><br>"
                    +"This is a freindly reminder to add your income and expenses for today in Money manager ,<br><br>"  
    ...
    public void sendDailyExpenseSummary(){
        ...
        List<ProfileEntity> profiles = profileRepository.findAll();
        for(ProfileEntity profile : profiles){
           List<ExpenseDTO> todaysExpenses = expenseService.getExpenseForUserOnDate(profile.getId(),LocalDate.now(ZoneId.of("Asia/Kolkata")));
            if(!todaysExpenses.isEmpty()){
                    ...
                    emailService.sendEmail(profile.getEmail(),"Youe daily Expense summary",body);
            }
        }
